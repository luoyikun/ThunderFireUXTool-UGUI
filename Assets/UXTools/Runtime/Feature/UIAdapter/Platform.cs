...
public class Platform
{
    ...
    public static void InitPlatformInfo()
    {
		...
		{
			if (Platform.CheckIsStandalone || Platform.CheckIsEditor || Platform.CheckIsXboxPC)
			{
				CheckGetPlatformType = PlatformType.PC;
			}
			else if (Platform.CheckIsPS4 || Platform.CheckIsPS5 || Platform.CheckIsXbox)
			{
				CheckGetPlatformType = PlatformType.Console;
			}
			else if (Platform.CheckIsAndroid || Platform.CheckIsIOS)
			{
